...
class PluginServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (app()->runningInConsole()) {
            ...
            $this->publishes([__DIR__ . '/../../resources/views' => resource_path('views/vendor/pluginClone')], 'PluginViews');
            $this->publishes([__DIR__ . '/../../resources/lang' => resource_path('lang/vendor/pluginClone')], 'PluginLang');
            $this->publishes([
