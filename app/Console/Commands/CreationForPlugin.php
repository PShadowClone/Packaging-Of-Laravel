...
use Illuminate\Database\Eloquent\Model;
    ...
    private function makeController($pluginName, $controllerName)
    {
        ...
        $newControllerContent = str_replace(['class Controller'], 'class ' . ucfirst($controllerName), $controllerContent);
    ...
    private function makeModel($pluginName, $modelName)
    {
        ...
        $this->info($modelName);
        $newContent = str_replace(['{namespace}'], 'Packages\\' . $pluginName . '\\' . 'src', $this->MODEL_CONTENT);
